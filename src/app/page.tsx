        ...
        <section className="relative py-12 md:py-0 min-h-[600px] h-auto md:h-[600px] flex items-center bg-[#E6F3F5] overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-10 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="order-2 md:order-1 space-y-6">
              <div className="inline-block bg-white/80 backdrop-blur px-4 py-2 rounded-full text-primary-dark font-bold text-sm uppercase tracking-widest border border-primary/10 shadow-sm animate-fade-in-up">
          ...
          <div className="flex justify-between md:justify-center gap-4 md:gap-8 min-w-max px-2">
            {categories.map((cat, idx) => (
              <Link key={idx} href={`/shop?category=${cat.name}`} className="group flex flex-col items-center gap-2 cursor-pointer">
                <div className="w-14 h-14 md:w-20 md:h-20 rounded-full bg-cream-light border-2 border-transparent group-hover:border-primary flex items-center justify-center text-2xl md:text-4xl shadow-sm group-hover:shadow-md transition-all transform group-hover:scale-110 duration-300">
                  {cat.icon}
                </div>
          ...
          <ScrollReveal width="100%">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl h-[400px] group cursor-pointer">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent flex flex-col justify-end p-10 transform translate-y-2 group-hover:translate-y-0 transition-transform">
                  <h3 className="text-white text-3xl font-serif font-bold mb-2">The Power of Millets</h3>
                  <p className="text-gray-200 mb-6 line-clamp-2 group-hover:line-clamp-none transition-all">Learn why millets are considered the "Superfood of the Century" and how we process them naturally.</p>
              ...
              <div className="bg-secondary rounded-2xl p-10 flex flex-col justify-center text-white relative overflow-hidden shadow-2xl h-[400px] group">
                <div className="absolute top-0 right-0 opacity-10 transform translate-x-1/4 -translate-y-1/4 group-hover:scale-150 transition-transform duration-700">
                ...
                <h3 className="text-3xl font-serif font-bold mb-6 relative z-10 leading-snug">"The Ragi noodles are a game changer! My kids love them and I'm happy they're eating healthy."</h3>
                <div className="flex items-center gap-4 mt-auto">
                  <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center font-bold text-xl border-2 border-white/30">AM</div>
                  <div>
                    <p className="font-bold text-lg">Anita Maheshwari</p>
                    <p className="text-white/80 text-sm">Verified Buyer</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              <div className="flex flex-col items-center group">
                <div className="w-16 h-16 mb-4 text-primary group-hover:scale-110 transition-transform duration-300">
